...
/* WEBPACK VAR INJECTION */(function(process, global, module) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;var require;var __WEBPACK_AMD_DEFINE_RESULT__;function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
(function () {
  var object =  true ? exports : undefined; // #8: web
  // workers
  ...
  object.atob || (object.atob = function (input) {
    ...
    buffer = input.charAt(idx++); // character found in table? initialize bit storage and add its ascii
    // value;
...
var HiPay = function (HiPay) {
  ...
  var _getLocaleTranslationWithId = function _getLocaleTranslationWithId(id) {
  ...
  function _focusNextElement() {
    ...
    if (document.activeElement) {
      if (_testSelector(focussableElements)) {
        ...
        var focussable = Array.prototype.filter.call(document.querySelectorAll(focussableElementsOldBrowser), function (element) {
          return element.offsetWidth > 0 || element.offsetHeight > 0 || element === document.activeElement;
        });
      }
  ...
  var _Error = function _Error(code, message) {
  ...
  var _defineProperties = function _defineProperties(object, properties) {
    for (var key in properties) {
      properties[key].propertyDescriptors = _extend({}, {
        enumerable: true,
        writable: false,
        configurable: false
      }, properties[key].propertyDescriptors || {});
    }
  ...
  var _bootstrapInstanceProperties = function _bootstrapInstanceProperties(instance) {
    if (_canDefineProperty) {
      var propertyConfig = [];
  ...
  var _setCaretPosition = function _setCaretPosition(ctrl, pos) {
  ...
  var _getSelection = function _getSelection(target) {
    var s = {
      start: 0,
      end: 0
    };
  ...
  var _serviceCreditCard = function _serviceCreditCard(charCode) {
    ...
    var _inputCCNumberFinish = function _inputCCNumberFinish(element) {
    ...
    var _inputCardExpiryDateFinish = function _inputCardExpiryDateFinish(element) {
    ...
    serviceCreditCard.validatorCreditCardNumber = function (errorArray) {
      ...
      var _isEnabled = function _isEnabled(cardTypeId) {
      ...
      var _isTypeValid = function _isTypeValid(cardTypeId) {
        if (_cardFormatDefinition.hasOwnProperty(cardTypeId) === false) {
          return false;
        }
      };

      var _isLengthValid = function _isLengthValid(value) {
      ...
      var _isLuhnValid = function _isLuhnValid(value) {
        var nCheck = 0,
            nDigit = 0,
            bEven = false;
    ...
    serviceCreditCard.validatorCreditCardHolder = function (errorArray) {
      ...
      validatorCreditCardHolder.isValid = function (creditCardHolderString) {
        ...
        if (creditCardHolderString && reg.test(creditCardHolderString)) {
        ...
        if (creditCardHolderString && count > 8) {
          validatorCreditCardHolder.errorCollection.push(new _InvalidParametersError(50, _getLocaleTranslationWithId("FORM_ERROR_INVALID_CARD_HOLDER_STRING")));
          return false;
        }
      ...
      validatorCreditCardHolder.isPotentiallyValid = function (creditCardHolderString) {
        ...
        if (creditCardHolderString && !reg.test(creditCardHolderString) && count <= 8 && creditCardHolderString.length <= serviceCreditCard.creditCardHolderLengthMax) {
          isPotentiallyValid = true;
        }
    ...
    serviceCreditCard.initCreditCardHolder = function (charCode, stringPaste) {
      ...
      for (var nbBefore = 0; nbBefore <= newTempStringAfter.length; nbBefore++) {
        if (nbBefore == startA) {
          if (charCode == 8 || charCode == 46) {} else {
            if (stringPaste) {
              startAtemp = startAtemp + stringPaste.length;
            } else {
              tempStringAfter += serviceCreditCard.lastCharStringCreditCardHolder; // realCursorPositionInNumberAfter = realCursorPositionInNumberBefore + 1;
    ...
    serviceCreditCard.initCreditCardExpiryDate = function (charCode, stringPaste) {
      ...
      var getStartEndCursor = _getSelection(_selectElementWithHipayId(_idInputMapper['cardExpiryDate'])); // position avant action avec formatage.
  ...
  var _addClassOnElement = function _addClassOnElement(elements, myClass) {
    if (!elements) {
      return;
    }
  ...
  var _removeClassOnElement = function _removeClassOnElement(elements, myClass) {
    if (!elements) {
      return;
    }
  ...
  var _containsClassOnElement = function _containsClassOnElement(elements, myClass) {
    if (!elements) {
      return;
    }
  ...
  var _initErrorHandler = function _initErrorHandler(e) {
  ...
  var _addListenerMulti = function _addListenerMulti(idElement, s, fn) {
  ...
  var _selectElementWithHipayId = function _selectElementWithHipayId(idHiPay) {
  ...
  var _selectElementValueWithHipayId = function _selectElementValueWithHipayId(idHiPay) {
    if (_selectElementWithHipayId(idHiPay)) {
      return _selectElementWithHipayId(idHiPay).value;
    }
  };

  var _setElementValueWithHipayId = function _setElementValueWithHipayId(idHiPay, value) {
    if (_selectElementWithHipayId(idHiPay)) {
  ...
  var _initListenEvent = function _initListenEvent(idElement) {
    _addListenerMulti(idElement, 'keydown keypress paste blur focus', _initErrorHandler);
  };

  var _initPlaceholder = function _initPlaceholder() {
  ...
  var _updatePlaceholderCVV = function _updatePlaceholderCVV(cardTypeId) {
    if (_selectElementWithHipayId(_idInputMapper["cardCVV"])) {
  ...
  var _addFieldListener = function _addFieldListener(node, event, handler, capture) {
  ...
  var _initAllFieldsEventListener = function _initAllFieldsEventListener() {
  ...
  var _initCardNumberFieldEventListener = function _initCardNumberFieldEventListener() {
    ...
    var cardNumberHandlerKeydown = function cardNumberHandlerKeydown(e) {
    ...
    var cardNumberHandlerPaste = function cardNumberHandlerPaste(e) {
      var evt = e || window.event;
      var pastedText = "";
    ...
    var cardNumberHandlerCut = function cardNumberHandlerCut(e) {
      setTimeout(function () {
        _instanceServiceCreditCard = new _serviceCreditCard();
    ...
    var cardNumberHandlerKeypress = function cardNumberHandlerKeypress(e) {
      var evt = e || window.event;
      var charCode = evt.keyCode || evt.which;
    ...
    var cardNumberHandlerChange = function cardNumberHandlerChange(e) {
      var evt = e || window.event;
      evt.preventDefault ? evt.preventDefault() : evt.returnValue = false;
      _instanceServiceCreditCard = new _serviceCreditCard();
  ...
  var _initCardHolderFieldEventListener = function _initCardHolderFieldEventListener() {
    ...
    var cardHolderHandlerKeydown = function cardHolderHandlerKeydown(e) {
      var evt = e || window.event;
      var charCode = evt.keyCode || evt.which;
    ...
    var cardHolderHandlerPaste = function cardHolderHandlerPaste(e) {
      var evt = e || window.event;
      var pastedText = "";
    ...
    var cardHolderHandlerCut = function cardHolderHandlerCut(e) {
      setTimeout(function () {
        _instanceServiceCreditCard = new _serviceCreditCard();
    ...
    var cardHolderHandlerKeypress = function cardHolderHandlerKeypress(e) {
      var evt = e || window.event;
      var charCode = evt.keyCode || evt.which;
    ...
    var cardHolderHandlerChange = function cardHolderHandlerChange(e) {
      var evt = e || window.event;
  ...
  var _initCardExpiryDateFieldEventListener = function _initCardExpiryDateFieldEventListener() {
    ...
    var cardExpiryDateHandlerKeydown = function cardExpiryDateHandlerKeydown(e) {
      var evt = e || window.event;
      var charCode = evt.keyCode || evt.which;
    ...
    var cardExpiryDateHandlerKeypress = function cardExpiryDateHandlerKeypress(e) {
      var evt = e || window.event;
      var charCode = evt.keyCode || evt.which;
    ...
    var cardExpiryDateHandlerPaste = function cardExpiryDateHandlerPaste(e) {
      var evt = e || window.event;
      var pastedText = "";
  ...
  var _initCVVFieldEventListener = function _initCVVFieldEventListener() {
    var propt = 'cardCVV';
    ...
    var cardCVVHandlerKeydown = function cardCVVHandlerKeydown(e) {
      var evt = e || window.event;
      var charCode = evt.keyCode || evt.which;
    ...
    var cardCVVHandlerKeypress = function cardCVVHandlerKeypress(e) {
      var evt = e || window.event;
      var charCode = evt.keyCode || evt.which;
    ...
    var cardCVVHandlerExpiryDatePaste = function cardCVVHandlerExpiryDatePaste(e) {
      var evt = e || window.event;
      var pastedText = "";
  ...
  var _initCardExpiryMonthFieldEventListener = function _initCardExpiryMonthFieldEventListener() {
    ...
    var cardExpiryMonthHandlerScanExpiry = function cardExpiryMonthHandlerScanExpiry(e) {
      var evt = e || window.event;
  ...
  var _initCardExpiryYearFieldEventListener = function _initCardExpiryYearFieldEventListener() {
    ...
    var cardExpiryYearHandlerScanExpiry = function cardExpiryYearHandlerScanExpiry(e) {
      var evt = e || window.event;
  ...
  var _elementIsDefined = function _elementIsDefined(element) {
  ...
  var _getParamsFromForm = function _getParamsFromForm() {
  ...
  HiPay.Form.paymentFormDataGetErrors = function () {
    ...
    if (creditCardNumberUnformatted != "") {
      if (!validatorCreditCardNumber.isPotentiallyValid(creditCardNumberUnformatted) || !validatorCreditCardNumber.isValid(creditCardNumberUnformatted) && _selectElementWithHipayId(_idInputMapper.cardNumber) !== document.activeElement) {
    ...
    if (typeof creditCardHolderString != 'undefined' && creditCardHolderString != "") {
      if (validatorCreditCardHolder.isPotentiallyValid(creditCardHolderString) == false || validatorCreditCardHolder.isValid(creditCardHolderString) == false && _selectElementWithHipayId(_idInputMapper.cardHolder) && _selectElementWithHipayId(_idInputMapper.cardHolder) !== document.activeElement) {
    ...
    if (creditCardExpiryDateString != "") {
      if (!validatorCreditCardExpiryDate.isPotentiallyValid(creditCardExpiryDateString) || !validatorCreditCardExpiryDate.isValid(creditCardExpiryDateString) && _selectElementWithHipayId(_idInputMapper['cardExpiryDate']) !== document.activeElement) {
    ...
    if (creditCardCVVString != "") {
      if (!validatorCreditCardCVV.isPotentiallyValid(creditCardCVVString, creditCardNumberUnformatted) || !validatorCreditCardCVV.isValid(creditCardCVVString) && _selectElementWithHipayId(_idInputMapper['cardCVV']) !== document.activeElement) {
        if (_selectElementWithHipayId(_idInputMapper['cardCVV'])) {
  ...
  var _processObjectPayload = function _processObjectPayload(instance, payload, specialValueCallback) {
    var propertyConfig = [];

    for (var key in payload || {}) {
      if (_typeof(instance._mapping) === 'object') {
    ...
    Object.defineProperty(Element.prototype, 'classList', {
      get: function get() {
        ...
        bValue.remove = function () {
          ...
          for (i in arguments) {
            for (var j = 0; j < bValue.length; j++) {
              if (bValue[j] != arguments[i]) self.className += (self.className ? " " : "") + bValue[j];
            }
          }
        };
  ...
  var _performAPICall = function _performAPICall(endpoint, requestParams, returnPromise, checkKey) {
  ...
  var _initAvailableAndEnabledPaymentProductsCollection = function _initAvailableAndEnabledPaymentProductsCollection() {
  ...
  var _getAvailablePaymentProducts = function _getAvailablePaymentProducts() {
  ...
  var _initListPaymentMethod = function _initListPaymentMethod() {
  ...
  var _APIError = function _APIError(data) {
    var payload;
  ...
  var _InvalidFormTokenizationError = function _InvalidFormTokenizationError(errorCollection) {
    _processObjectPayload(this, {
...
/***/ 1:
/*!*************************************!*\
  !*** multi ./resources/js/hipay.js ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/yguillemain/Desktop/code/centrale-marketplace/resources/js/hipay.js */"./resources/js/hipay.js");
